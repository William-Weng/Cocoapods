...
public class WWRotaryWheel: UIView {
    ...
    @IBInspectable var buttonColor: UIColor = #colorLiteral(red: 0.9568627477, green: 0.6588235497, blue: 0.5450980663, alpha: 1)
    ...
    @IBInspectable var count: UInt = 3 { willSet { setNeedsDisplay(); layoutIfNeeded() }}
